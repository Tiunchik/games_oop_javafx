...
public enum Cell {
    ...
    /**
     * Метод добавлен из материалов лекции для организции поиска объекта класса Cell
     *
     * @param x - параметр определяющий горизонтаьное положние ячейки на доске
     * @param y - параметр определяющий вертикальное положние ячейки на доске
     * @return - ячейка сответствующая параметрам
     */
